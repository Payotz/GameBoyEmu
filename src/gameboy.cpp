...
void op_0x9(){
    lh.whole += cb.whole;
    flagreg_n = 0;
    flagreg_h = (opcode & 0b0000010000000000) >> 10;
    flagreg_c = (opcode & 0b0100000000000000) >> 14;
    pc += 2;
}
...
void op_FxE(){
    auto result = fa.low - (opcode & 0x000F);
    if(result == 0){
        flagreg_z = 1;
    }
